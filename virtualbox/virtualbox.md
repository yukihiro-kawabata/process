...
############################################################################################################
## phpmyadminをブラウザ上で見る方法 参考ページ http://mrs.suzu841.com/tebiki/centos55/phpmyadmin.html    ###
...
###########################################################################
###    virtualboxのネットワーク設定(Basic Server)※desktopは住ぐるに    ###
###########################################################################
...
##############################################################
###    cronの設定  参考サイト http://oxynotes.com/?p=6912  ###
##############################################################
yum install cronie-noanacron
service crond start
chkconfig crond on

CentOS 6系では定期実行は   /etc/anacrontab
...
######################
###  xhprofの設定  ###  参考サイト -->  http://qiita.com/morisuke/items/49f17bda2c764ae8f725
######################
...
#####################################################################  参考URL http://d.hatena.ne.jp/kanonji/20120206/1328511612
###    virtualboxで rootユーザーでmaintenanceモードに入ったら   #####          http://www.atmarkit.co.jp/flinux/rensai/linuxtips/974fsck.html
